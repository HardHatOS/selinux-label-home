...
License: AGPLv3+
Name: hos-selinux-label-public_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: public_home.te
Summary: SELinux policy module (label only) for the Public directory
URL: https://github.com/HardHatOS/selinux-label-home/public_home
Version: 1.0

%description
SELinux policy module (label only) for the $HOME/Public directory
