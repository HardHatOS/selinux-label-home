...
License: AGPLv3+
Name: hos-selinux-label-pictures_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: pictures_home.te
Summary: SELinux policy module (label only) for the Pictures directory
URL: https://github.com/HardHatOS/selinux-label-home/pictures_home
Version: 1.0

%description
SELinux policy module (label only) for the $HOME/Pictures directory
