...
License: AGPLv3+
Name: hos-selinux-label-templates_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: templates_home.te
Summary: SELinux policy module (label only) for the Templates directory
URL: https://github.com/HardHatOS/selinux-label-home/templates_home
Version: 1.0

%description
SELinux policy module (label only) for the $HOME/Templates directory
