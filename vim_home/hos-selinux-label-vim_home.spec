...
License: AGPLv3+
Name: hos-selinux-label-vim_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: vim_home.te
Summary: SELinux policy module (label only) for vim files
URL: https://github.com/HardHatOS/selinux-label-home/vim_home
Version: 1.0

%description
SELinux policy module (label only) for vim files within the $HOME directory
