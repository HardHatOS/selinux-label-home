...
License: AGPLv3+
Name: hos-selinux-label-bash_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: bash_home.te
Summary: SELinux policy module (label only) for Bash files
URL: https://github.com/HardHatOS/selinux-label-home/bash_home
Version: 1.0

%description
SELinux policy module (label only) for Bash files within the $HOME directory
