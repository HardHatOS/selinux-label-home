...
License: AGPLv3+
Name: hos-selinux-label-downloads_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: downloads_home.te
Summary: SELinux policy module (label only) for the Downloads directory
URL: https://github.com/HardHatOS/selinux-label-home/downloads_home
Version: 1.0

%description
SELinux policy module (label only) for the $HOME/Downloads directory
