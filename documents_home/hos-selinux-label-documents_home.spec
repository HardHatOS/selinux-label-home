...
License: AGPLv3+
Name: hos-selinux-label-documents_home
Release: 1%{?dist}
Requires: policycoreutils, libselinux-utils
Source0: documents_home.te
Summary: SELinux policy module (label only) for the Documents directory
URL: https://github.com/HardHatOS/selinux-label-home/documents_home
Version: 1.0

%description
SELinux policy module (label only) for the $HOME/Documents directory
